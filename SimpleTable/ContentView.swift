...
struct ContentView: View {
    ...
    let images: [String] = ["Travail", "HaiHai","Nixta","Sammys","kramarczuk","hmongkitchen","soulbowl","spoonstable","billysushi","RestaurantAlma","Owamni","ZenBox","Mannys","keefer","Pimento","lus","Quang","sooki","Mannys","Taqueria"]
    var body: some View {
        VStack{
