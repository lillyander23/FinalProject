...
struct SongStored {
    ...
    static func songs() -> [SongStored]{
        var top25Songs: [SongStored] = []
        
        
        for i in 0...24 {
            top25Songs.append(SongStored(artistName: artistNameTop25[i], songName: songNameTop25[i], releaseDate: releaseDateTop25[i], artworkUrl100: artworkUrl100Top25[i], liked: false))
        }
        return top25Songs
    }
   static func filterSong(songList: [SongStored]) -> [SongStored]{
...
let artistNameTop25 = ["Metro Boomin","Drake & 21 Savage","Taylor Swift","Lil Baby","Rod Wave","Babyface Ray","Ivan Cornejo","Finesse2Tymes","SZA","Bad Bunny","Rod Wave","Beyoncé","Arcángel","Quando Rondo & YoungBoy Never Broke Again","Quavo & Takeoff","SZA","Kodak Black","Future","A Boogie wit da Hoodie","GloRilla","Roddy Ricch","Key Glock","YoungBoy Never Broke Again","Morgan Wallen"];
let songNameTop25 = ["HEROES & VILLAINS (Heroes Version)","Her Loss","Midnights (3am Edition)","It's Only Me","Jupiter's Diary: 7 Day Theory","MOB","Dañado (Deluxe)","90 Days","SOS","Un Verano Sin Ti","Beautiful Mind","RENAISSANCE","SR. SANTOS","3860","Only Built For Infinity Links","Ctrl (Deluxe)","Kutthroat Bill: Vol. 1","I NEVER LIKED YOU","Me vs. Myself","Anyways, Life’s Great…","Feed Tha Streets III","PRE5L - EP","Ma’ I Got A Family (A Gangsta Grillz Special Edition Hosted by DJ Drama)","Dangerous: The Double Album"];
